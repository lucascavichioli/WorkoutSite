        ...
        <div className="grid justify-center">
            ...
            {listTrainingPlanTraining.map((list, index) => 
                <li key={index} className="flex flex-col space-y-1 m-4">
                    <a href={"/training/"+list.training.id+"/"+list.id} className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
